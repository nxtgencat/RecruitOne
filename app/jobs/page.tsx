...
export default function JobsPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'On Hold': return 'bg-violet-100 text-violet-700 border-violet-200'
    ...
    return (
        <div className="min-h-screen">
            {/* Gradient Header */}
            <div className="bg-gradient-to-r from-violet-600 via-purple-500 to-cyan-500 px-8 py-8 text-white">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Jobs</h1>
                        <p className="text-white/80 mt-1">Manage your job postings and hiring pipelines.</p>
                    </div>
            ...
            <div className="p-6 -mt-4">
                <Card className="border-purple-100 shadow-lg">
                    <CardHeader className="pb-3 bg-gradient-to-r from-purple-50 to-cyan-50">
                        <CardTitle className="text-purple-800">All Jobs</CardTitle>
                    </CardHeader>
                    <CardContent>
