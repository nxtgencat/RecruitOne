...
export default function CandidatesPage() {
    ...
    return (
        <div className="min-h-screen">
            {/* Gradient Header */}
            <div className="bg-gradient-to-r from-cyan-600 via-purple-500 to-violet-500 px-8 py-8 text-white">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Candidates</h1>
                        <p className="text-white/80 mt-1">Manage and track your candidate pipeline.</p>
                    </div>
                    <Button onClick={() => setOpenDialog(true)} className="gap-2 bg-white text-purple-600 hover:bg-white/90">
            ...
            <div className="p-6 -mt-4">
                <Card className="border-purple-100 shadow-lg">
                    <CardHeader className="pb-3 bg-gradient-to-r from-cyan-50 to-purple-50">
                        <CardTitle className="text-purple-800">All Candidates</CardTitle>
                    </CardHeader>
                    <CardContent>
